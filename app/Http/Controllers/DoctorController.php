...
class DoctorController extends Controller
{
    ...
    {
        return view('hospitals.doctors.create', ['doctor'=> new Doctor()]);
    }
    ...
    public function store(DoctorStore $request)
    {
        ...
        return back()->with('status','doctor agregado con exito');
    }
    ...
    {
        return view('hospitals.doctors.edit',['doctor'=> $doctor]);
    }
    ...
    public function update(DoctorStore $request, Doctor $doctor)
    {
        ...
        return back()->with('status','doctor fue modificado con éxito');
    }
